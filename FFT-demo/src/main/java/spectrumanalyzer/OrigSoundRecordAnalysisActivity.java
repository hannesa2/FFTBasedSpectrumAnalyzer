...
public class OrigSoundRecordAnalysisActivity extends Activity implements OnClickListener {
	...
	static OrigSoundRecordAnalysisActivity mainActivity;
	...
	static OrigSoundRecordAnalysisActivity getMainActivity() {
